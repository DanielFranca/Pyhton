...
- Alfumas Linguagens de programação (C/JAVA) possuem uma estrutura de dados chamadas de arrays;
    - Unidimensionais (Arrays/Vetores):
    - Multidimensionais (Matrizes);

Em python nós temos as Listas

numeros = (1, 'b', 2.325, True, 5)

#Exemplos

listas = [[1, 2, 3], [4, 5, 6], [7, 8, 9]] #é matriz 3 x 3
