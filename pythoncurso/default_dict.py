"""
Default Collections - Default Dict
...
essa chave será criado e valor default será atribuido.

OBS: lanbdas são funções sem nome, que podem ou não receber parâmetros de entrada e retornar valores
